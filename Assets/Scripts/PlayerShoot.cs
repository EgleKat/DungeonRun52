...
public class PlayerShoot : MonoBehaviour
{
    ...
    private void FireBullet(int gunID)
    {
        ...
        if (gunID == 0)
        {
            ...
            GameObject fb;
            fb = Instantiate(bullets[0], transform.position + new Vector3(0, -0.2f, 0), Quaternion.identity);
        ...
        else if (gunID == 1)
        {
            ...
            {
                GameObject fb;
                fb = Instantiate(bullets[1], transform.position + new Vector3(0, -0.2f, 0), Quaternion.identity);
        ...
        else if (gunID == 2)
        {
            ...
            fb = Instantiate(bullets[2], transform.position + new Vector3(fireVector.x, fireVector.y, 0) * 0.5f + new Vector3(0, -0.2f, 0), rot);
        ...
        else if (gunID == 3)
        {
            ...
            fb = Instantiate(bullets[3], transform.position + new Vector3(0, -0.2f, 0), Quaternion.identity);
        ...
        else if (gunID == 4)
        {
            ...
            GameObject fb;
            fb = Instantiate(bullets[4], transform.position + new Vector3(0, -0.2f, 0), Quaternion.identity);
    ...
    public void SetGun(int gunID)
    {
        ...
        {
            infoTextObject.GetComponent<FadeInOut>().ShowText("Sub-Machine Gun");
        }
        else if (gunID == 4)
        {
            infoTextObject.GetComponent<FadeInOut>().ShowText("Magic Wand");
        }
        else if (gunID == 0)
        {
            infoTextObject.GetComponent<FadeInOut>().ShowText("Peashooter");
        }
    }
}
